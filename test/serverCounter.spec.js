...
it('생성시 버튼과 초기값을 렌더링한다.', async () => {
	...
	expect(container.querySelect('.btn-inc')).toBeVisible();
	expect(container.querySelect('.btn-dec')).toBeVisible();
	expect(container.querySelect('.value')).toHaveTextContent('0');
});
